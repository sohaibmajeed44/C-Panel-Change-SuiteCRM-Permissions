<?php
//set the mod to TRUE or FALSE as per the need
...
if($chmod_debug_mode == TRUE)
  echo "($cmod_result) Changed permissions to: " . $fullpath . " with : " . $perms['file_perms'] . "
";
                }else {
                    $cmod_result = chmod($fullpath, $perms['dir_perms']);
if($chmod_debug_mode == TRUE)
  echo "($cmod_result) Changed permissions to: " . $fullpath . " with : " . $perms['dir_perms'] . "
";
